  ...
  return (
    <>
      <header className="pointer-events-none fixed inset-x-0 top-0 z-40 flex justify-center px-6 pt-4">
        <div className="pointer-events-auto flex w-full max-w-3xl items-center justify-between rounded-2xl border border-hairline bg-surface px-5 py-3 shadow-[0_8px_24px_rgba(23,24,26,0.06)]">
          <span className="font-display text-xl text-ink">TradeJournal</span>
      ...
      <div className="mx-auto flex w-full max-w-3xl flex-1 flex-col px-6 pb-10 pt-24 sm:pb-16 sm:pt-28">
